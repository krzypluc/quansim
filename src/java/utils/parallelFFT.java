...
//
//    public static Complex[] FFTComplex1D(Complex[] y, SharedRunJob) {
//        int procID = PCJ.myId();
...
//
//        Complex[] yFragmentBuffer = new Complex[1];
...
//                PCJ.asyncPut(transformed, procID - loopNumber, nextYFragment);
//            }
//
//            else {
//                break;
